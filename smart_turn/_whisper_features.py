...
#
# Vendored verbatim from pipecat-ai/pipecat at commit
# d7f1abc0c38d91b9c8345d404ce39386db2939fe
# (src/pipecat/audio/turn/smart_turn/_whisper_features.py).
# See smart_turn/THIRD_PARTY_NOTICE.md for the full license text and
# provenance. Not modified from upstream.
#
